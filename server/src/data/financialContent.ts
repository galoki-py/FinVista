...
export const financialContent: LearningModule[] = [
  ...
  },
  {
    ...
    content: 'Investing in property (land, residential, commercial). It offers potential for rental income and capital appreciation. For students, "REITs" (Real Estate Investment Trusts) allow you to invest in large-scale real estate with small amounts of money.',
    tier: 4
  },
  {
    id: 'gold-01',
